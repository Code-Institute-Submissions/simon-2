...
<br>this seems to be linked to the toggle strict button that I used instead of the standard implimentation, as it ussually only happens if you toggle strict off after toggling it on,
<br>I fixed this by using a more normal strict mode implimentation,
